...
https://github.com/user-attachments/assets/9a4fbded-e600-4b12-bf4f-27e9c088fc38
...
https://github.com/user-attachments/assets/8ec30fef-7ad6-42a0-90cb-bcd262b1432c
...
// Default fbo value is set to 2

makeFBO: Call this function during initialization to set up an off-screen rendering target. The generated FBO can then be used for post-processing, shadow mapping, or other rendering techniques requiring intermediate buffers.

paintTexture: Render a fullscreen quad using a specified texture and applies post-processing effects controlled by shader uniforms

### Collaboration/References

### Known Bugs

Cropping Issue on Saved Image
